...
command_t kots_commands[] =
{
    ...
    "kots_update", "Updates to the latest version of KOTS2024", Kots_Update, true,
    "kots_revert", "Reverts to the last saved version of KOTS2024", Kots_Revert, true,
    "kots_rcon", "Provides rcon-like functionality for KOTS2024 admins", Kots_RCon, true,
